...
- Entity, symbol, icons - Add Font awesome icons () , font awesome cdn , symbol -> unicode-symbol
-> icon fonts -> extensions  to search icons
...
- Link
- Image
- frames  -> help to load other website in you web page
- media - audio, video
